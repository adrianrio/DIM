...
<div class="bg-white">
    ...
    <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Profile Page</h2>
            <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                <div class="lg:flex lg:flex-auto lg:justify-center">
                    <dl class="w-64 space-y-8 xl:w-80">
                        <div class="flex flex-col-reverse gap-y-4">
                            <dt class="text-3xl leading-7 text-gray-600">Raised in total donations</dt>
                            <dd class="text-5xl font-semibold tracking-tight text-gray-900">Username</dd>
                        </div>
                        <div class="flex flex-col-reverse gap-y-4">
                            <dt class="text-3xl leading-7 text-gray-600">Raised in total donations</dt>
                            <dd class="text-5xl font-semibold tracking-tight text-gray-900">Phone Number</dd>
                        </div>
                        <div class="flex flex-col-reverse gap-y-4">
                            <dt class="text-3xl leading-7 text-gray-600">Schools are our partners</dt>
                            <dd class="text-5xl font-semibold tracking-tight text-gray-900">Email</dd>
                        </div>
                    </dl>
                </div>
            </div>
